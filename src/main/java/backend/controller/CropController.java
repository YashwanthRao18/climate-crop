...
import backend.model.InputData;
import backend.model.RecommendationResponse;
import backend.service.CropService;
...
public class CropController {
    ...
    private RecommendationResponse errorResponse() {
        return new RecommendationResponse(
                "N/A",
                "N/A",
                "⚠️ Please wait for some time or check location",
                0, 0, 0,
                "Error"
        );
    }
